...
class _StandDetailScreenState extends State<StandDetailScreen>
    ...
    return Scaffold(
      body: CustomScrollView(
        slivers: [
          ...
          SliverAppBar(
            iconTheme: IconThemeData(color: AppTheme.mainBackgroundColor),
            expandedHeight: 250,
            pinned: true,
            backgroundColor:  AppTheme.mainBackgroundColor,
            title: Text(widget.stand.name, textAlign: TextAlign.start, ),
          ...
          SliverPersistentHeader(
            ...
            delegate: _SliverAppBarDelegate(
              TabBar(
                ...
                tabs: [
                  Tab(text: '${l10n.productsLabel} (${widget.stand.products.length})'),
                  Tab(text: '${l10n.videosLabel} (${widget.stand.videos.length})'),
                  Tab(text: '${l10n.catalogueLabel} (${widget.stand.catalogues.length})'),
                  Tab(text: '${l10n.teamsLabel} (${widget.stand.members.length})'),
                ],
              ),
            ),
          ),
      ...
      children: [
        ...
        Expanded(
          child: Text( 
            ...
            style: TextStyle(
              fontSize: 14,
              color: isLink ? AppTheme.accentColor : Colors.grey[700],
  ...
  Widget _buildParticipantsTabs() {
    if (widget.stand.members.isEmpty) {
      return Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
    ...
    return ListView.builder(
      ...
      itemCount: widget.stand.members.length,
      itemBuilder: (context, index) {
        final p = widget.stand.members[index];
        return ParticipantCard(participant: p);
      },
    );
  }
}
