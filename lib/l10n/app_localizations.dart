...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      "event_label":"Event",
      "date_label":"Choose the day of the appointment", 
      ...
      "time_label": "Choose the appointment time",
      "location_label":"Choose the meeting place",
      "send_label":"Send",
      "home_label":"Home",
    ...
    'fr': {
      ...
      "date_label":"Choisissez le jour du rendez-vous",  
      ...
      "time_label": "Choisissez l’horaire du rendez-vous",
      "location_label":"Choisissez le lieu du rendez-vous",
      "send_label":"Envoyer",
      "home_label":"Accueil",
      ...
      "email_equired_validation_content":"Pour accéder à la plateforme, veuillez confirmer votre adresse e-mail. \nUn e-mail de vérification vous a été envoyé. \n🔔 Pensez de vérifier votre dossier spam / courrier indésirable. \nSi vous n’avez rien reçu, cliquez sur « Renvoyer l’e-mail ».",
      "email_equired_validation_button":"Renvoyer l'e-mail",
      "refresh_label":"Continuer", 
